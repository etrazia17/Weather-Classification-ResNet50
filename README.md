...
Images are preprocessed and used for training and validation.
...
- Optimized using categorical crossentropy loss
...
The model shows strong performance in classifying unseen weather images.
